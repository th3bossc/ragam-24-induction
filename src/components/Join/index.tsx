...
const Join = () => {
    return (
        <div className="h-full min-h-screen w-full relative flex flex-col xl:flex-row justify-center gap-16 xl:gap-0 xl:justify-between items-center p-4 xl:p-24 overflow-hidden">
            <div className="flex flex-col gap-[1.5rem] w-full xl:w-[45.8125rem] text-center xl:text-left     h-auto">
                <span className={`${ibmPlexSerif.className} text-3xl xl:text-[2.375rem] font-semibold leading-normal`}> Join us</span>
